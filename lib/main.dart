  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Padding(
            ...
            child: Column(
              children: [
                FlatButton(child: Text('Omitir'), onPressed: () {
                ...
                ButtonBlue(text: 'Registrarme con mi e-mail', route: '/signup/'),
                Container(height: 8,),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
          ...
          child: Column(
          children: [
            Text('¡Hola! Para seguir, ingresa tu e-mail o usuario',
              style: TextStyle(
                fontSize: 28
              ),
            ),
...
class Home extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                        ...
                        Column(
                          children: [
                            ...
                            Container(
                                ...
                                child:Text('Podrás ver detalles de envío '
      ...
      child: Container(
        padding: EdgeInsets.only(right:13, left:13, top:30, bottom: 30),
        child: Column(
          children:[
            CarouselSlider(
            ...
            items: imgHomeList.map((item) => Container(
              child: Center(
                  child: Image(image: AssetImage(item), width:350, fit: BoxFit.cover, height: 200)
              ),
            )).toList(),
          ),
            Container(
              ...
              child: Row(
                children: [
                  HomeFloatingButton(icon: Icons.qr_code, text: 'Pagar con QR'),
                  HomeFloatingButton(icon: Icons.label_important, text: 'Ofertas'),
                  HomeFloatingButton(icon: Icons.shopping_basket_outlined, text: 'Súper'),
                  HomeFloatingButton(icon: Icons.emoji_transportation_sharp, text: 'Autos y otros'),
                  HomeFloatingButton(icon: Icons.more_horiz, text: 'Ver más'),
                ],
              )
            ),
            HomeSingleComponent(
    ...
    return Scaffold(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Container(height: 10),
              Text('Nuevo | 889 vendidos', style: TextStyle(color: Colors.grey)),
              Container(height: 8),
              Text('Laptop Huawei Mateboox 13', style: TextStyle(fontSize: 25)),
              Row(
                children:[
                Text('por '),
                Container(
                  ...
                  child: FlatButton(
                    ...
                    child: Text('Tienda Oficial Huawei México',
                      style: TextStyle(
                          color: Colors.blue
                      ),
                    ),
              ...
              Row(children: [
                ...
                Container(width: 10),
                Text('(169)', style: TextStyle(color:Colors.blue, fontSize: 12))
              ]),
              Container(height: 10),
              ...
              child: Scaffold(
                ...
                body: CarouselSlider(
                    ...
                    items: imgList.map((item) => Container(
                      child: Center(
                        child: Image(image: AssetImage(item), width:800, fit: BoxFit.cover)
                      ),
                    )).toList(),
                )
              )),
              Container(height:20),
              Text('\$ 36,999', style: TextStyle(fontSize: 17,
                  decoration: TextDecoration.lineThrough)),
              Row(
                children: [
                  Text('\$ 30,599', style: TextStyle(fontSize: 35)),
                  Container(width: 10),
                  Text('11% OFF', style: TextStyle(color: Colors.green,
                      fontSize: 20))
                ]
              ),
              Container(height: 5),
              Row(children:[
                ...
                Text(' 12x \$ 1,333 sin interés', style: TextStyle(color: Colors.green,
                    fontSize: 20))
              ]),
              Container(height: 20),
              Row(children:[
      ...
      child: Scaffold(
        ...
        body: TabBarView(children: [
                  ...
                  child: Column(
                      children: [
                          ...
                          children: [
                            Expanded(
                              ...
                              child: Align(alignment: Alignment.centerLeft,
                                ...
                                child: Text('Agregar domicilio de entrega',
                                    style: TextStyle(
                                        color: Colors.blue,
                                        fontSize: 16)),
                              ))
                            ...
                            Expanded(
                              ...
                              child: Align(
                                  ...
                                  child:Text('Gratis      ', style: TextStyle(
                                    color: Colors.green,
                                    fontSize: 17
                                  )))
                            )
                        ...
                        Align(alignment: Alignment.centerLeft,
                            child: FlatButton(
                              child: Text('Agregar tarjeta o medio de pago',
                                    style: TextStyle(
                                      color: Colors.blue,
                                      fontSize: 16),),
                                onPressed: () {
                          ...
                          children:[
                            Expanded(
                                ...
                                child: Align(
                                    ...
                                    child: Text('   Total con envío', style: TextStyle(
                                  fontSize:22
                                )))
                            ),
                            Expanded(
                                ...
                                child: Align(
                                    alignment: Alignment.centerRight,
                                    child: Text('\$18, 067   ',style: TextStyle(
                                    fontSize:22
                                ))
                            ))
                          ]
          ...
          Padding(
            ...
            child: Column(
              children:[
                Text('No tienes productos guardados', style: TextStyle(fontSize: 25)),
                Container(height:10),
                Text('Si aún no estás decidido en comprar algún producto de tu'
        ...
        child: Padding(
          ...
          child:Column(
            children: [
              ...
              Align(
                  alignment: Alignment.centerLeft,
                  child: Text('Tu clave debe tener entre 6 y 20 caracteres y '
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        iconTheme: IconThemeData(
            color:Colors.black),
        title: Align(alignment: Alignment.center, child: Text('Agregar Domicilio',
            style: TextStyle(
              color: Colors.black,
              fontSize: 22,
              fontWeight: FontWeight.bold))),
...
class ButtonBlue extends StatelessWidget{
  final String text;
  final String route;
  ButtonBlue({Key key, @required this.text, this.route});
...
class ButtonWhite extends StatelessWidget{
  final String text;
  final String route;
  ButtonWhite({Key key, @required this.text, this.route});
...
class TextInput extends StatelessWidget{
  final String text;
  TextInput({Key key, @required this.text});
...
class DrawerIcon extends StatelessWidget{
  ...
  DrawerIcon({Key key, @required this.icon, this.text}) : super(key:key);
  ...
  Widget build(BuildContext context) {
    ...
    return RichText(
      ...
      text: TextSpan(
        style: defaultStyle,
        children: <TextSpan>[
          TextSpan(text: 'Al inscribirme declaro que soy mayor de edad y acepto'
              ' las '),
          TextSpan(
...
class HomeFloatingButton extends StatelessWidget{
  ...
  HomeFloatingButton({Key key, @required this.icon, this.text}) : super(key:key);
        ...
        Column(
          children: [
            FloatingActionButton(
              ...
              onPressed: () => {},
              backgroundColor: Colors.white,
              child: Icon(this.icon, color: Colors.grey,),
            ),
            Container(height: 10),
  ...
  Widget build(BuildContext context) {
      ...
      child: Column(
        children: [
          Expanded(
            flex: 1,
            child: Padding(padding: EdgeInsets.only(left: 10), child:Align(
              alignment: Alignment.centerLeft,
...
class HomeBigArticle extends StatelessWidget{
  ...
  HomeBigArticle({Key key, @required this.title, this.image, this.price});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            Image(image: AssetImage(this.image), width: 300),
            ...
            Row(children:[Text(this.price, style: TextStyle(
              fontSize: 20
            )), Text('  38% OFF', style: TextStyle(
              fontSize: 16,
              color: Colors.green
            )),]),
            Align(alignment: Alignment.centerLeft, child:Text('12 x \$ 110.26', style: TextStyle(color: Colors.green, fontSize: 16)),
            ),
            Align(alignment: Alignment.centerLeft, child:Text('Envío gratis', style: TextStyle(color: Colors.green, fontSize: 16))
            )]
        )
      )
    );
...
class HomeSmallArticle extends StatelessWidget{
  ...
  HomeSmallArticle({Key key, @required this.title, this.image, this.price});
...
class CarritoArticle extends StatelessWidget{
  ...
  CarritoArticle({Key key, @required this.title, this.image, this.price});
                ...
                Expanded(
                    ...
                    child: Column(
                        children: [
                          ...
                          Align(alignment: Alignment.centerLeft,
                              child:FlatButton(child: Text('Eliminar',
...
class LineOfDomicilio extends StatelessWidget{
  ...
  LineOfDomicilio({Key key, @required this.text});
